    ...
    <header className="sticky top-0 z-50 bg-black text-white shadow-md">
      <nav className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
        ...
        <ul className="hidden md:flex items-center gap-8 text-sm font-semibold">
          <li>
            <Link href="/#hero" className="hover:text-[#c1ff72] transition">
              Home
            </Link>
          </li>
          <li>
            <Link href="/#services" className="hover:text-[#c1ff72] transition">
              Services
            </Link>
          </li>
          <li>
          ...
          <li>
            <Link href="/#contact" className="hover:text-[#c1ff72] transition">
              Contact
            </Link>
          </li>
        </ul>
